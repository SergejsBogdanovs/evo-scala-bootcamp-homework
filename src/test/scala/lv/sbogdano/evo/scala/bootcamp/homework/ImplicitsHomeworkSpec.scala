...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import lv.sbogdano.evo.scala.bootcamp.homework.implicits_and_typeclasses.ImplicitsHomework.SuperVipCollections4s._
          |import lv.sbogdano.evo.scala.bootcamp.homework.implicits_and_typeclasses.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import lv.sbogdano.evo.scala.bootcamp.homework.implicits_and_typeclasses.ImplicitsHomework.MyTwitter._
