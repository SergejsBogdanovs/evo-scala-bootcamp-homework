...
import lv.sbogdano.evo.scala.bootcamp.homework.course_project.ws.messages.action.OutputAction._
...
object OutputAction {
  ...
  case class OutputActionError(error: RepositoryOpsError) extends OutputAction
}

sealed trait OutputActionError extends OutputAction
object OutputActionError {
