package lv.sbogdano.evo.scala.bootcamp.homework.course_project.http.auth
...
import lv.sbogdano.evo.scala.bootcamp.homework.course_project.domain.auth.{Admin, AuthResponseError, AuthResponseSuccess, Role, User, Worker}
